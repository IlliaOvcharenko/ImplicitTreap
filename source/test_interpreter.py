...
Functions:
    ...
    test <test_name>
    Выполняет команду clean и read_file для теста test_name (test_name - название файла в папке 
    tests без указания расширения .txt, эта информация подставляется автоманически)
